...
@section('content')
    <h1 class="display-1">Rares</small></h1>
    <p class='lead'>Create a new Event for {{ $tagGroup->name }}</p>
    <h2>Form</h2>
    <form method="POST" action="{{ route('management.rares.events.store', $tagGroup) }}">
        @csrf
        <div class="mb-3">
